...
# NEMO
sudo apt-get -yqq install subversion libqimageblitz-dev python-dev
...
# Don't use these until after we install UCX/OpenMPI
unset CC
unset FC
...
make clean
./configure --prefix=/usr --enable-static --enable-shared --with-cuda=/usr/include --enable-mpi-cxx
...
make clean
./configure --prefix=/usr --enable-parallel-tests --enable-netcdf-4
